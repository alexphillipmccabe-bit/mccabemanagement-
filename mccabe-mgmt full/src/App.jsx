...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100 font-sans">
      ...
      {/* CONTACT — ARTISTS */}
      <section id="contact-artists" className="mx-auto max-w-6xl px-4 py-24 border-top border-neutral-200 dark:border-neutral-800">
            ...
            <div className="rounded-3xl border border-neutral-200 dark:border-neutral-800 p-6">
              <form
                onSubmit={(e)=>{
                  ...
                  mailto('artists@mccabemgmt.com', subject, body);
                }}
              ...
              >
                ...
                <p className="text-xs text-neutral-500">This opens your email client with the details prefilled to send to artists@mccabemgmt.com.</p>
              </form>
            </div>
          </div>
      ...
      {/* CONTACT — VENUES */}
      <section id="contact-venues" className="mx-auto max-w-6xl px-4 py-24 border-top border-neutral-200 dark:border-neutral-800">
        <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="rounded-3xl border border-neutral-200 dark:border-neutral-800 p-6">
              <form
                onSubmit={(e)=>{
                  ...
                  mailto('bookings@mccabemgmt.com', subject, body);
                }}
                className="grid gap-4 text-left"
              >
                <div>
                ...
                <p className="text-xs text-neutral-500">This opens your email client with the details prefilled to send to bookings@mccabemgmt.com.</p>
              </form>
            </div>
          </div>
        </div>
